...
var gender = "male";
var DOB = "1985-12-10";
var license_number = "1234-5678-9111";
var policy_number = "4444-5555-3333-2222";
...
// EXERCISE 1 SECTION 2-33 PAGE 81
a = " 101.1 "
b = "55"
c = "402 Stevens"
d = "Number 5 "
console.log(parseInt(a)); // 101
console.log(parseFloat(a)); // 101
console.log(Number(a)); // 101
console.log(+a); // 101
...
console.log("The area of a retangle is " + area);
